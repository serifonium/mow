...
let functionIcons = new SpreadSheet("./imgs/functions.png", v(8, 8), v(64, 64), {
    "spawn":v(0, 0), "moveCam":v(1, 0), "spawnEnemy":v(2, 0), "function":v(3, 0),
    "teleport":v(4, 0), "typeCam":v(5, 0), "trigger":v(6, 0), "funct":v(7, 0),
})


let virtueSignals = new SpreadSheet("./imgs/virtueSignals.png", v(4, 4), v(128, 128))
let huskSprites = new SpreadSheet("./imgs/huskSprites.png", v(8, 4), v(64, 128))

let punchFrames = new SpreadSheet("./imgs/punchFrames.png", v(8, 8), v(64, 64))